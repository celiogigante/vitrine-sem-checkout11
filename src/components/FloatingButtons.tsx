  ...
  return (
    <div className="fixed bottom-6 right-6 z-40 flex flex-col gap-4">
      ...
      <a
        ...
        className="flex h-14 w-14 items-center justify-center rounded-full shadow-lg transition-transform hover:scale-110 animate-float-bounce bg-emerald-500 hover:bg-emerald-600"
